            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
					                    ...
					                    <li class="active"><?php echo "<a href='consulterTheme.php?etu=$etu'>";?>Mes Themes</a></li>
                    ...
                    <div class="col-sm-12">
                        <fieldset >
                            ...
                            <div class="row" align="center">
                              <h3><b> Etudiant(e):</b> <?php echo ($sq['Nom']) ?> <?php echo( $sq['Prenom'])?>  </h3>
                        ...
                        <div class="col-sm-12">
                           ...
                           <table border="2" style="width:1000px "  class="table table-striped table-hover table-bordered " style="border-radius=1px"><thead>


                    <tr>
                        <th align="center" style="width:370px; height:50px;"> Theme </th>
						                        <th align="center" >explication </th>
												                        <th align="center" style="width:100px; height:70px;">Encadreur</th>
...
try {
    ...
    $total = $db->query("
        SELECT
            COUNT(*)
        FROM
            theme where  specialite like '%{$sq['specialite']}%' and statut=1
...
// The "back" link
    ...
    // The "forward" link
    $nextlink = ($page < $pages) ? '<a href="?etu='.$etu.'&amp;page=' . ($page + 1) . '"&amp;etu=$id3 title="page suivant"> &nbsp;&nbsp;
...
<td>".$ligne["explication"]."</td>
<td>".$resu["Nom"]." ".$resu["Prenom"]."</td>
