            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
					                    ...
					                    <li><?php echo "<a href='consulterTheme.php?etu=$etu'>";?>Mes Themes</a></li>
                    ...
                    <li  class="active"><a href="#">Affectation Themes</a></li>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <fieldset >
                                ...
                                <legend>Liste des themes affecter:</legend>
                              
                           <table border="2" style="width:1000px "  class="table table-striped table-hover table-bordered " style="border-radius=1px"><thead>


                    <tr>
                        <th align="center" style="width:300px; height:50px;"> Etudiant </th>
						                        <th align="center" >Theme </th>
												                        <th align="center" style="width:300px; height:50px;">Encadreur</th>
...
try {
    ...
    $total = $db->query("
        SELECT
            COUNT(*)
        FROM
            voeux where  specialite like '%{$sq['specialite']}%' 
