...
if(isset($_POST['submit'])) {
        ...
        $sql = $db->prepare('update nbrsujet set nbr=? ');
...
if(isset($_POST['submit1'])) {
        ...
        $sql = $db->prepare('insert into specialite (specialite) values (?) ');
        $params = array($_POST['specialite']);
        $sql->execute($params);
...
<div>>
    ...
    <h3>Entrez le nbr de sujet proposée </h3><br>
...
<form method="post" action="" enctype="multipart/form-data"  >
    <h3>Entrez le nom de spécialité </h3><br>
    <input type="text" name="specialite" /><br><br>
   <input  type='submit' name='submit1' class='btn btn-danger' value='Enregistrer'  ></div>
</form>
